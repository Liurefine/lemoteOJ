...
static 	$DB_PASS="lemote970310";  //数据库密码

static 	$OJ_NAME="UPCOJ";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
static  $OJ_LANGMASK=2097076; //1mC 2mCPP 4mPascal 8mJava 16mRuby 32mBash 1008 for security reason to mask all other language
